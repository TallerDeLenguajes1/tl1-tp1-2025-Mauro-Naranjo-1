2. 
* Es conveniente incluir un archivo .gitignore para no subir archivos innecesarios al repositorio, como pueden ser archivos temporales, configuraciones, archivos .exe que pueden regenerarse, datos sensibles, etc.
* Lo ideal es hacerlos al inicio del proyecto asi evitas subir cosas innecesarias desde un principio.
* Un archivo de texto llamado .gitignore con la extension de los archivos a ignorar.
* Para ignorar un archivo ignorado.txt pondria su nombre y extension en el archivo .gitignore.
